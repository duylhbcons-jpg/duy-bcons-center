...
const PAYMENT_OPTIONS: PaymentOption[] = [
    {
        ...
        usp: "Chiết khấu 5.65%",
        description:
            "Dành cho khách hàng có sẵn dòng tiền nhàn rỗi, muốn tối ưu giá mua.",
    ...
    },
    {
        ...
        description:
            "Lựa chọn phổ biến nhất, tận dụng đòn bẩy tài chính tối đa.",
        ...
        schedule: [
            ...
            {
                milestone: "Ngân hàng giải ngân",
                percentage: "50%",
                note: "Lãi suất 0% & Ân hạn 18T",
            },
            { milestone: "Thông báo nhận nhà", percentage: "25%" },
            { milestone: "Sổ hồng", percentage: "5%" },
        ],
    ...
    },
    {
        ...
        description:
            "Gói đặc quyền kết hợp ngân hàng OCB, tối ưu vốn ban đầu nhất.",
...
const PaymentPolicySection: React.FC = () => {
    ...
    return (
        <section
            id="chinh-sach"
            className="relative py-20 md:py-28 bg-[#0f223d] overflow-hidden"
        >
            {/* Background decor */}
                ...
                >
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight">
                            Chính Sách &{" "}
                            <span className="text-amber-400">Khuyến Mãi</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {PROMOTIONS.map((promo, index) => (
                            ...
                            >
                                <div
                                    className={`w-12 h-12 ${promo.color} rounded-xl flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300`}
                                >
                                    {promo.icon}
                                </div>
                ...
                <div className="mb-12">
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight">
                            Chọn Phương Án{" "}
                            <span className="text-amber-400">Phù Hợp Bạn</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        {PAYMENT_OPTIONS.map((option) => (
                            ...
                            >
                                ...
                                <div
                                    className={`p-6 md:p-7 bg-white/5 ${option.featured ? "pt-10" : ""}`}
                                >
                                    ...
                                    <div
                                        className={`mt-5 w-full py-3 rounded-xl text-xs font-black uppercase tracking-widest text-center transition-all ${
                                            selected === option.id
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    >
                        <img
                            ...
                            alt="Ưu đãi tặng 3 chỉ vàng khi mua căn hộ Bcons Center City"
                    ...
                    >
                        ...
                        <p className="text-white/60 text-sm md:text-base leading-relaxed font-light">
                            Đăng ký ngay hôm nay để nhận ưu đãi đặc biệt tháng
                            7/2026: Tặng{" "}
                            <strong className="text-amber-400">
                                3 chỉ vàng
                            </strong>
                            , lãi suất 0% và ân hạn gốc 18 tháng. Số lượng suất
                            ưu đãi có hạn.
                        </p>
